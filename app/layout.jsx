  ...
  return (
    <html lang="id">
      <body className="relative min-h-screen overflow-x-hidden bg-base-950 text-slate-200 antialiased">
        ...
        <div className="pointer-events-none fixed -top-40 left-1/4 -z-10 h-96 w-96 rounded-full bg-purple-600/20 blur-[120px]" />
        <div className="pointer-events-none fixed top-1/3 right-0 -z-10 h-80 w-80 rounded-full bg-fuchsia-600/10 blur-[120px]" />
